...
public class Keyboard {
    ...
    public static String readString() {
        ...
        try {
            ...
            error("Errore nella lettura dei dati di tipo String, valore null restituito.");
            str = null;
        }
        return str;
    }
    ...
    public static String readWord() {
        ...
        try {
            ...
            error("Errore nella lettura dei dati di tipo String, è stato restituito un valore null.");
            token = null;
        }
        return token;
    }
    ...
    public static boolean readBoolean() {
        ...
        try {
            if (token.toLowerCase().equals("true"))
                ...
                error("Errore nella lettura dei dati di tipo boolean, è stato restituito un valore false.");
                bool = false;
            }
        } catch (Exception exception) {
            error("Errore nella lettura dei dati di tipo booleano, è stato restituito un valore false.");
            bool = false;
        }
        return bool;
    }
    ...
    public static char readChar() {
        ...
        try {
            ...
            error("Errore nella lettura dei dati di tipo char, è stato restituito il valore MIN_VALUE.");
    ...
    public static int readInt() {
        ...
        try {
            ...
            error("Errore nella lettura dei dati di tipo int, è stato restituito il valore MIN_VALUE.");
    ...
    public static long readLong() {
        ...
        try {
            ...
            error("Errore nella lettura dei dati di tipo long, è stato restituito il valore MIN_VALUE.");
    ...
    public static float readFloat() {
        ...
        try {
            ...
            error("Errore nella lettura dei dati di tipo float, è stato restituito il valore NaN.");
            value = Float.NaN;
        }
        return value;
    }
    ...
    public static double readDouble() {
        ...
        try {
            ...
            error("Errore nella lettura dei dati di tipo double, è stato restituito il valore NaN.");
            value = Double.NaN;
        }
        return value;
    }
